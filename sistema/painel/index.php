...
<body class="cbp-spmenu-push">
	<div class="main-content">
			...
			<aside class="sidebar-left" style="overflow: scroll; height:100%; scrollbar-width: thin;">
				<nav class="navbar navbar-inverse">
					<div class="navbar-header">
						...
						<h1><a class="navbar-brand" href="index.php"><span class="fa fa-cutlery"></span> Painel ADM<span class="dashboard_text"><?php echo $nome_sistema ?></span></a></h1>
					</div>
		...
		<!--footer-->
		<div class="footer">
			<p>&copy; Delivery interativo - desenvolvido por Diógenes Oliveira - Whats; 889 8190-9378<a href="#" target="_blank"></a></p>
		</div>
		<!--//footer-->
	</div>
