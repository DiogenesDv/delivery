...
<td>
	...
	<li class="dropdown head-dpdn2" style="display: inline-block;">
		<big><big><a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><big><i class="fa fa-trash-o text-danger"></i></big></a>
		...
		<a href="#" onclick="ativarVar('{$id}', '{$acao}')" title="{$titulo_link}"><i class="fa {$icone} text-success"></i></a></big></big>
